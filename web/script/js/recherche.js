...
//                alert(data[i].city.city);
                ...
                artist.className = "member col-xs-12 col-sm-4 col-md-3 col-lg-2";
                ...
                var styleText = document.createTextNode(data[i].style);
    ...
    $.ajax({
        ...
        success: function (data) {
            for (var i = 0; i < data.length; i++) {
                ...
                host.className = "member col-xs-12 col-sm-4 col-md-3 col-lg-2";
...
//                if (data[i].img !== null && data[i].name !== null && data[i].adress !== null) {
                ...
                place.className = "member col-xs-12 col-sm-4 col-md-3 col-lg-2";
